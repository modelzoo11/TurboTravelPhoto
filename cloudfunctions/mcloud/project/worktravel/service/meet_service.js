...
class MeetService extends BaseProjectService {
	...
	// 用户预约逻辑
	async prepay(userId, meetId, packageIdx, timeMark, formsList) {
	...
	async viewMeet(userId, meetId) {
		...
		ret.MEET_PHONE = meet.MEET_PHONE;
		ret.MEET_ITEM_LIST = meet.MEET_ITEM_LIST;
	...
	async detailForJoin(userId, meetId, timeMark) {
		...
		let fields = 'MEET_ITEM_LIST,MEET_DAYS_SET,MEET_JOIN_FORMS, MEET_TITLE';
	...
	async getMeetList({
		...
		let fields = 'MEET_ITEM_LIST,MEET_TITLE,MEET_OBJ,MEET_DAYS,MEET_CATE_NAME,MEET_CATE_ID,MEET_ITEM_MIN_PRICE';
	...
	async getMyJoinDetail(userId, joinId) {
		...
		let fields = 'JOIN_ITEM,JOIN_PAY_STATUS,JOIN_PAY_FEE,JOIN_COMPLETE_END_TIME,JOIN_IS_CHECKIN,JOIN_CHECKIN_TIME,JOIN_REASON,JOIN_MEET_ID,JOIN_MEET_TITLE,JOIN_MEET_DAY,JOIN_MEET_TIME_START,JOIN_MEET_TIME_END,JOIN_STATUS,JOIN_ADD_TIME,JOIN_CODE,JOIN_FORMS';
	...
	async getMyJoinList(userId, {
		...
		let fields = 'JOIN_ITEM.name,JOIN_COMPLETE_END_TIME,JOIN_IS_CHECKIN,JOIN_REASON,JOIN_MEET_ID,JOIN_MEET_TITLE,JOIN_MEET_DAY,JOIN_MEET_TIME_START,JOIN_MEET_TIME_END,JOIN_STATUS,JOIN_ADD_TIME,JOIN_OBJ';
